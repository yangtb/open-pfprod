    ...
    var c = {
        ...
        tabAdd: function (i) {
            ...
            if (t.tabExists(s)) t.tabChange(s); else {
                ...
                -1 !== n.indexOf("fa-") ? r.push('<i class="fa ' + n + '" aria-hidden="true"></i>') : r.push('<i class="iconfont ' + n + '"></i>'), r.push("&nbsp;" + l), r.push('<i class="layui-icon layui-unselect layui-tab-close">&#x1006;</i>'), r.push("</li>");
