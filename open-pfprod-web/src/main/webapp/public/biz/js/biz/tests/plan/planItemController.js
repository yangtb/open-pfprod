layui.config({
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            url: basePath + '/pf/r/test/plan/tree',
            type: 'post',
            dataType: 'json',
    ...
    table.render({
        ...
        , url: basePath + '/pf/p/test/plan/item/list'
        , where: {
    ...
    $('#add').on('click', function () {
        ...
        var url = basePath + '/pf/r/test/plan/item/add';
    ...
    table.on('edit(questionTableFilter)', function (obj) {
        ...
        var bizData = {
            idTestplanMedicalrec: data.idTestplanMedicalrec,
            sort: value
        };
        var url = basePath + '/pf/r/test/plan/item/update/sort';
    ...
    var _delPaperItem = function (currentData) {
        var url = basePath + '/pf/r/test/plan/item/del';
        ...
        $.each(currentData, function (index, content) {
            ...
            reqData.push(content.idTestplanMedicalrec);
