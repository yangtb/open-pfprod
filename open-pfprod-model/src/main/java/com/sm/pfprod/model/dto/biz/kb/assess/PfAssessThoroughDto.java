...
import com.sm.pfprod.model.entity.FaqEvaCaseItemThorough;
...
@Getter
@ToString
public class PfAssessThoroughDto extends FaqEvaCaseItem implements Serializable {
     ...
     * 等效答案
     */
    private List<FaqEvaCaseItemThorough> list;
